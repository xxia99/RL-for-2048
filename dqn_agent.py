...
class DQN():
    ...
    def __init__(self, num_state, num_action, enable_double=False, enable_priority=True):
        ...
        self.eval_net, self.target_net = CNN_Net(self.state_len, num_action, self.conv_size, self.fc_size), CNN_Net(
            self.state_len, num_action, self.conv_size, self.fc_size)
